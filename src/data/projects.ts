...
export const projects: Project[] = [
  ...
  },
  {
    ...
    features: [
      "Conversion-focused hero with dual CTAs (strategy call booking & WhatsApp)",
      "Six service verticals presented as numbered stacked showcase cards",
      "Dedicated Success, About, Team, and Contact pages",
      "Floating WhatsApp widget for instant lead capture",
      "Minimal editorial design system with violet brand palette",
